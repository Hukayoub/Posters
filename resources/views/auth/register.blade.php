        ...
        <form action="{{route('register')}}" method="post">
         ...
         <div>
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Repaeat the password"
                class="bg-gray-100 border-2 w-full p-4 rounded-lg " value="">
                
            </div>
            <div class="mb-4">
                <button type="submit" class="bg-blue-600 text-white px-4 py-3 font-medium w-full rounded-lg mt-3 hover:bg-blue-500">Register</button>
            </div>
